    ...
    if data and points is not None:
        ...
        if marker_size:
            ...
            if success:
                ...
                # Извлекаем смещения по X и Y (в метрах)
                offset_x = tvec[0][0]  # или tvec[0] если tvec одномерный
                offset_y = tvec[1][0]  # или tvec[1]
                ...
                cv2.putText(frame, f"X: {offset_x:.2f}m", (10, 60),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
                cv2.putText(frame, f"Y: {offset_y:.2f}m", (10, 90),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
                cv2.putText(frame, f"Roll: {roll:.1f}", (10, 120),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
                cv2.putText(frame, f"Pitch: {pitch:.1f}", (10, 150),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
                cv2.putText(frame, f"Yaw: {yaw:.1f}", (10, 180),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
